...
This dissertation provides a comprehensive analysis of the design, implementation, and evaluation of a cloud-hosted web \ac{API} that integrates with external \acp{API} and cloud services. In contrast, most literature found on the subject focuses on
