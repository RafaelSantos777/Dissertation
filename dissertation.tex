...
\begin{description}
  \item [Chapter \ref{Chapter:Introduction}: \nameref{Chapter:Introduction}] This chapter introduces the context, motivation, research questions, and the research methodology of this dissertation.
  \item [Chapter \ref{Chapter:Literature_Search_Methodology}: \nameref{Chapter:Literature_Search_Methodology}] This chapter explains the literature\linebreak search methodology, including the strategy for identifying relevant literature and the papers included in the review.
