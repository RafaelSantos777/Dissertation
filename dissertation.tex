...
Considering the parameters and pricing options defined in Subsections \ref{Subsection:Cost_Analysis_Parameters} and \ref{Subsection:Cost_Analysis_Pricing_Options}, the estimated monthly cost of hosting the web \ac{API} in each cloud platform was calculated. Table \ref{Table:Cost_Analysis_Results} shows the results, in Euros.
